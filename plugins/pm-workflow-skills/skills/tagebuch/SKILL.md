...
Reine **Erzählschicht über dem Journal**: Die App generiert die Texte nicht
selbst; dieser Skill nutzt Claude als Textgenerator und schreibt über die MCP-Tools zurück.
Ein Dashboard-Widget „Tagebuch" zeigt das Ergebnis nur an, falls vorhanden.
...
Die Projekt-Manager-App-Infrastruktur muss laufen. Benötigte MCP-Tools: `report_activity`,
...
Quelle (Ebene 1): Skill Library, Plugin `pm-workflow-skills`, `reference/documentation/05-projekt-tagebuch.md`.
