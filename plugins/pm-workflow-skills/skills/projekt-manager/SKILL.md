...
Gilt nicht nur bei explizit beauftragten PM-Referenzen: siehe `mcp-code-auftrag` für die vollständige Auftrags-Orchestrierung, und den sitzungsweiten Logging-Hinweis (Stop-Hook dieses Plugins) für Arbeit ohne genannte Referenz.
